    ...
    >
      <FadeIn yOffset={20}>
        <div className="border border-charcoal bg-obsidian">
          <div className="grid gap-10 lg:grid-cols-[1.15fr_0.85fr] border-b border-charcoal/20 px-5 py-8 sm:px-10 sm:py-12 lg:px-16 lg:py-16 items-center">
            <div>
              ...
              <p className="mt-3 sm:mt-5 max-w-xl text-sm sm:text-base leading-relaxed text-charcoal/70">
          ...
          <div className="grid grid-cols-2 divide-x divide-charcoal/20 border-b border-charcoal/20 text-[9px] sm:text-[11px] font-mono font-medium uppercase tracking-[0.16em] sm:tracking-[0.18em] text-neonCyan sm:grid-cols-4">
            <span className="px-3.5 py-2.5 sm:px-6 sm:py-3.5">Project: Laxvish</span>
            <span className="px-3.5 py-2.5 sm:px-6 sm:py-3.5">Made in India</span>
            <span className="px-3.5 py-2.5 sm:px-6 sm:py-3.5">DPDP ready</span>
            <span className="px-3.5 py-2.5 sm:px-6 sm:py-3.5">Rev: {new Date().getFullYear()}</span>
          </div>
        </div>
      </FadeIn>

      <footer className="mt-8 sm:mt-12 flex flex-col items-start justify-between gap-3 border-t border-charcoal/20 pt-6 text-xs font-medium text-neonCyan sm:flex-row sm:items-center">
