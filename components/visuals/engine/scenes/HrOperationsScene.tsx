  ...
  return (
    <div className="relative flex min-h-[380px] w-full flex-col justify-between overflow-hidden rounded-3xl bg-[#FAF8F5] p-8 text-charcoal sm:p-12">
      ...
      <div className="relative my-auto flex w-full flex-col items-center justify-center py-6">
        {phase === "request" && (
          <div className="flex flex-col items-center text-center font-serif text-lg italic text-charcoal/80">
            ...
            <div className="flex gap-2">
              {["Priya Sharma (Senior Eng)", "+", "Maternity SOP 2026", "+", "26-Week Benefit"].map((token, i) => (
                <motion.span
                  ...
                  className="rounded-full bg-charcoal px-3.5 py-1.5 text-white font-medium"
                >
                  {token}
                </motion.span>
              ))}
        ...
        {phase === "resolved" && (
          ...
          >
            <div className="flex items-center justify-between border-b border-charcoal/10 pb-3 text-[10px] text-charcoal/40 uppercase">
              ...
              <span className="font-bold text-emerald-700">HRMS Updated (4 mins)</span>
            </div>
            <div className="mt-4 space-y-2">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-semibold text-emerald-700">DPDP & NSDL Verified ✓</span>
              </div>
            </div>
          </motion.div>
        )}
