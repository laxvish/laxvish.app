      ...
      >
        <AnimatePresence mode="wait">
          ...
          {shot === 0 && (
            ...
            >
              <div className="relative flex h-24 w-24 items-center justify-center rounded-3xl border border-vaultAmber/25 bg-voidSurface ">
          ...
          {shot === 1 && (
            ...
            >
              <motion.div
                ...
                className="relative flex h-28 w-28 items-center justify-center rounded-3xl border border-vaultAmber/50 bg-voidSurface p-40_0_40px_rgba(157,142,199,0.25)]"
              >
          ...
          {shot === 2 && (
            ...
            >
              <div className="relative rounded-2xl border border-vaultAmber/25 bg-voidSurface p-4 text-left ">
                ...
                <p className="mt-2 font-mono text-base text-charcoal/90 leading-relaxed">
          ...
          {(shot === 3 || shot === 4) && (
            ...
            >
              <div className="relative flex h-40 w-full max-w-lg items-center justify-center">
                ...
                <motion.div
                  animate={{ scale: [1, 1.15, 1], boxShadow: ["0 0 15px rgba(157,142,199,0.3)", "0 0 35px rgba(157,142,199,0.6)", "0 0 15px rgba(157,142,199,0.3)"] }}
                ...
                {[
                  ...
                  <motion.div
                    ...
                    className="absolute rounded-none border border-mark bg-voidSurface/90 px-3 py-1.5 font-mono text-xs text-charcoal whitespace-nowrap"
                  >
                    ✦ {shard.label}
                  </motion.div>
                ))}
