            ...
            {["Audience: 4,850 CROs", "Creative: DPDP Brief", "Channel: WhatsApp + Email", "Timing: Tuesday 9:00 AM"].map(
              (frag, idx) => (
                <motion.div
                  ...
                  className="rounded-xl border border-charcoal/15 bg-white px-4 py-2.5 shadow-sm text-charcoal"
                >
                  {frag}
                </motion.div>
              )
        ...
        {phase === "ready" && (
          ...
          >
            <div className="flex items-center justify-between border-b border-charcoal/10 pb-3 text-[10px] text-charcoal/40 uppercase">
              ...
              <span className="font-bold text-emerald-700">46.8% Open Rate Projected</span>
            </div>
            <div className="mt-4 space-y-2">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-bold text-charcoal">₹42.0L ARR</span>
              </div>
              <div className="flex justify-between">
                <span className="text-charcoal/50">Lead Sync:</span>
                <span className="font-semibold text-emerald-700">HubSpot Live Stream ✓</span>
              </div>
            </div>
          </motion.div>
        )}
