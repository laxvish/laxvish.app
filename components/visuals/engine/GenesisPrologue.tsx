...
export function GenesisPrologue() {
  ...
  return (
    <div
      ...
      className="relative mx-auto w-full max-w-5xl overflow-hidden rounded-none bg-[#EDE3D2] p-6 text-charcoal sm:p-10 border border-vaultAmber/20"
      style={{ perspective: "1000px" }}
    >
      {/* Cinematic Film Atmosphere & Anamorphic Glow */}
      
      
      <div className="pointer-events-none absolute inset-0 [background-size:28px_28px] opacity-40" />
      ...
      <div className="relative z-20 flex flex-wrap items-center justify-between gap-4 border-b border-vaultAmber/15 pb-4 font-mono text-xs">
        <div className="flex items-center gap-3">
          ...
          <span className="font-medium tracking-[0.18em] text-vaultAmber uppercase">
            GENESIS SEQUENCE · THE LAXVISH THREAD
          </span>
        </div>

        <div className="flex items-center gap-3 text-[11px] text-charcoal/70">
          <span className="rounded-none border border-mark bg-mark/10 px-3 py-1 font-mono text-vaultAmber">
          ...
          <button
            ...
            className="rounded-full border border-charcoal/20 bg-mist/30 px-3 py-1 font-mono text-[10px] text-charcoal hover:bg-mist/50 transition-colors cursor-pointer"
          >
      ...
      >
        ...
        <div className="mb-6 space-y-2">
          ...
          <div className="flex items-center justify-center gap-4 sm:gap-6 font-mono text-xs tracking-widest text-charcoal/80">
            ...
            <span className="text-vaultAmber/20">───────</span>
            <span className={step >= 4 ? "text-mark font-medium" : "text-charcoal/30"}>THE THREAD WEAVES</span>
            <span className="text-vaultAmber/20">───────</span>
        ...
        <div className="relative flex h-52 w-full max-w-2xl items-center justify-center">
          <AnimatePresence mode="wait">
            ...
            {step === 0 && (
              ...
              >
                <div className="h-2.5 w-2.5 rounded-full bg-vaultAmber/30 " />
                <span className="font-mono text-sm text-charcoal/50 max-w-md">
            ...
            {step === 2 && (
              <motion.div
                ...
                className="flex flex-col items-center gap-3"
              >
                <div className="relative flex h-20 w-20 items-center justify-center rounded-none border border-mark bg-voidSurface p-4 ">
                  ...
                  <span className="absolute -top-1 -right-1 flex h-3.5 w-3.5">
                    ...
                    <span className="block h-2 w-2 bg-mark" />
                  </span>
                </div>
            ...
            {step === 3 && (
              ...
              >
                <div className="w-full rounded-2xl border border-vaultAmber/20 bg-voidSurface/80 p-4 text-left ">
                  <div className="flex items-center justify-between border-b border-rule-hair pb-2 font-mono text-[10px] text-vaultAmber">
                    <span>AUDIO FREQUENCY CAPTURE</span>
                    <span className="font-bold text-neonCyan">THREAD SYNCHRONIZED (240ms)</span>
                  </div>
                  <p className="mt-2.5 font-mono text-sm text-charcoal/90">
                ...
                <svg viewBox="0 0 400 30" className="h-6 w-80 overflow-visible">
                  <motion.path
                    ...
                    strokeWidth="2"
                    fill="none"
                    filter="drop-shadow(0 0 6px rgba(157,142,199,0.7))"
                    animate={{
                      d: [
              ...
              >
                {[
                  ...
                  <motion.div
                    ...
                    className="flex items-center gap-2 rounded-none border border-mark bg-voidSurface px-4 py-2 text-charcoal "
                  >
            ...
            {step === 5 && (
              ...
              >
                ...
                <div className="mt-4 grid grid-cols-2 gap-3 font-mono text-xs">
                  <div className="rounded-xl bg-mist/30 p-3 border border-rule-hair">
        ...
        <div className="flex items-center gap-2">
          {[0, 1, 2, 3, 4, 5].map((idx) => (
            <button
              ...
              className={`h-1.5 rounded-full transition-all duration-300 cursor-pointer ${ step === idx ? "w-8 bg-mark" : "w-2 bg-charcoal/20 hover:bg-charcoal/40" }`}
