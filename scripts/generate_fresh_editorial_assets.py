...
Inside the central intersection, introduce a single horizontal capsule-shaped control track. A small circular or rounded rectangular marker sits precisely at the center of the track, suggesting a controlled boundary between two states.
...
The control marker should be extremely subtle and integrated into the geometry.

### Color system
STRICT MONOCHROME.
Use only:
- warm ivory / off-white background (#F5F3EE)
- pale stone (#E6E3DC)
- muted gray (#969792)
- dark charcoal (#252525)

No blue, purple, cyan, green, red, orange, or accent colors. Do not use colorful gradients. Prefer solid fills with tonal contrast.
...
### Visual metaphor
Do NOT draw a literal shield, lock, robot, brain, circuit board, neural network, warning symbol, or mechanical brake caliper. Make containment and deliberate boundaries the metaphor.
...
### Final instruction
Make it feel like a piece of premium 2D visual identity design, not an AI-generated illustration. Flat. Precise. Quiet. Intelligent. Monochromatic. Editorial. Architectural."""
    },
    {
        "filename": "editorial-voice-dialogue.png",
        "description": "CallMe — Realtime AI Voice Pipeline & Conversational Flow",
        "prompt": """Create a flat 2D, highly art-directed editorial graphic for an enterprise AI system website, representing Realtime Conversational Voice AI, acoustic streaming, and natural dialogue synthesis.

The artwork must look like it was created by a world-class brand designer using precise vector geometry, not rendered in 3D and not generated as a generic AI illustration.

### Visual concept
Create one abstract, intelligent geometric composition representing the transformation of natural acoustic speech into structured, verified conversational dialogue.
The composition consists of three horizontal rounded vector wave bands of graduated lengths that flow from the left and smoothly transition into a singular, grounded circular dialogue token on the right.
...
Acoustic speech stream ↔ structured conversational dialogue
Between the wave bands and the circular token lies a crisp 2px hairline whitespace channel that denotes sub-millisecond precision, transition, and clarity.
The visual should read as an iconic corporate identity mark or acoustic diagram rather than a software interface.
...
Make it feel like a piece of premium 2D visual identity design, not an AI-generated illustration. Flat. Precise. Quiet. Intelligent. Monochromatic. Editorial. Architectural."""
    },
    {
        ...
        "description": "System Architecture — Multi-Agent Stack & Enterprise Deployment",
...
Make it feel like a piece of premium 2D visual identity design, not an AI-generated illustration. Flat. Precise. Quiet. Intelligent. Monochromatic. Editorial. Architectural."""
    },
    {
        ...
        "description": "Workers Page — Autonomous Domain Task Execution",
...
Make it feel like a piece of premium 2D visual identity design, not an AI-generated illustration. Flat. Precise. Quiet. Intelligent. Monochromatic. Editorial. Architectural."""
    },
    {
        ...
        "description": "Brain — Multi-Agent Orchestration & Neural Routing",
...
def delete_old_images():
    old_files = [
        "brain-routing-mesh.png",
        "brakes-interlock-macro.png",
        "callme-acoustic-macro.png",
        "callme-ribbon-mic.png",
        "final-cta-architecture.png",
        "security-vault-bolt.png",
        "solutions-document-optical.png",
        "solutions-finance-balance.png",
        "solutions-sales-telemetry.png",
        "solutions-support-acoustic.png",
        "verification-wafer-macro.png",
        "workers-actuator-macro.png",
        "test-voice.png"
    ]
    for of in old_files:
        p = os.path.join(OUTPUT_DIR, of)
        if os.path.exists(p):
            os.remove(p)
            print(f"Deleted old file: {of}")

def main():
    os.makedirs(OUTPUT_DIR, exist_ok=True)
    delete_old_images()
    with ThreadPoolExecutor(max_workers=3) as executor:
        futures = {executor.submit(generate_and_save, item): item["filename"] for item in NEW_EDITORIAL_ASSETS}
